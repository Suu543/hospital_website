...
const FeatureContainer = styled.section`
  ...
  opacity: 0.8;
  background-image: linear-gradient(135deg, #f7eee4 25%, transparent 25%),
    linear-gradient(225deg, #f7eee4 25%, transparent 25%),
    linear-gradient(45deg, #f7eee4 25%, transparent 25%),
    linear-gradient(315deg, #f7eee4 25%, #f9f5f1 25%);
...
const FeatureHeaderComponent = () => {
  return (
    <FeatureHeader>
      <h4>의사들이 가족을 위해 선택하는 병원 마리아유외과 - 유방전문클리닉</h4>
      <h2>마리아유외과 병원소개</h2>
    </FeatureHeader>
  );
};
